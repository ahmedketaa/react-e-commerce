...
<label className="btn  iconBtn" for="option1">    <FontAwesomeIcon className="star  radioIcon" icon={faPersonDress} />
<p className="text-dark">Women's Cloth</p>
</label>
...
<label className="btn   iconBtn" for="option2">    <FontAwesomeIcon className="star  radioIcon" icon={faPerson} />
<p className="text-dark">Men's Cloth</p>
</label>
...
<label className="btn  iconBtn" for="option3">    <FontAwesomeIcon className="star  radioIcon" icon={faGem} />
<p className="text-dark">Jewelery</p>
</label>
...
<label className="btn  iconBtn" for="option4">    <FontAwesomeIcon className="star radioIcon" icon={faMicrochip} />
